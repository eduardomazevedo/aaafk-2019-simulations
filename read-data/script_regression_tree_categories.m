...
gradient.index = [];
matchProb.index = [];
submissionsData = [submissionsData gradient matchProb];
gradient.groupTree = submissionsData.groupTree;
submissionsData2 = [gradient matchProb];
%dwlRegressionTreeCategories_3
writetable(submissionsData, './output/regressionTreeCategories.csv');
