...
SS = aassGet('./analysis/different-compositions/75th-participation/scale_small/');
...
writetable(S, './analysis/different-compositions/75th-participation/scale_small/output/scalesummary.csv');
...
f = figure();
    ...
    xlabel('Arrival Rate');
print('./output-for-manuscript/figures/production-function-75th-small.eps', '-depsc2');
print('./output/figures/production-function-75th-small.eps', '-depsc2');
% Average product:
f = figure();
    f.Position = [0, 0, 162*3, 100*3];
    errorbar([0, S.scaleGrid'], ...
    ...
    xlabel('Arrival Rate');
    % Save
print('./output-for-manuscript/figures/average-product-func-75th-small.eps', '-depsc2');
print('./output/figures/average-product-func-75th-small.eps', '-depsc2');