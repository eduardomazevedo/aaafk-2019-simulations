...
addpath('./analysis/gradient/');
spec;
rmpath('./analysis/gradient/');
clear optionsArray qArray;

[f, f_se] = aassGetMean('./analysis/gradient/');
...
writetable(outputTable, './analysis/gradient/output/gradient.csv');
...
summaryTable.se = sqrt( ...
    ...
    + (f0_se/stepSize)^2);
writetable(summaryTable, './analysis/gradient/output/summarytable.csv');