...
addpath('./analysis/robustness/lower-waittime/gradient/');
spec;
rmpath('./analysis/robustness/lower-waittime/gradient/');
clear optionsArray qArray;

[f, f_se] = aassGetMean('./analysis/robustness/lower-waittime/gradient/');


%% Load data of f at the origin
[f0, f0_se] = aassReduce(aassGet('./analysis/robustness/lower-waittime/matching-probability/'));
...
writetable(outputTable, './analysis/robustness/lower-waittime/gradient/output/gradient.csv');
...
summaryTable.se = sqrt( ...
    ...
    + (f0_se/stepSize)^2);
writetable(summaryTable, './analysis/robustness/lower-waittime/gradient/output/summarytable.csv');