...
%% Load data
S = aassGet('./analysis/robustness/lower-waittime/matching-probability/data');
...
%% Save
writetable(results, './analysis/robustness/lower-waittime/matching-probability/output/matching-probability.csv');