...
addpath('./analysis/robustness/higher-waittime/gradient/');
spec;
rmpath('./analysis/robustness/higher-waittime/gradient/');
clear optionsArray qArray;

[f, f_se] = aassGetMean('./analysis/robustness/higher-waittime/gradient/');


%% Load data of f at the origin
[f0, f0_se] = aassReduce(aassGet('./analysis/robustness/higher-waittime/matching-probability/'));
...
writetable(outputTable, './analysis/robustness/higher-waittime/gradient/output/gradient.csv');
...
summaryTable.se = sqrt( ...
    ...
    + (f0_se/stepSize)^2);
writetable(summaryTable, './analysis/robustness/higher-waittime/gradient/output/summarytable.csv');