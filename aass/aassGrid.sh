...
qsub -l m_mem_free=10G -v TODOPATH="$1"  -v HOSPITSIZE="$3" -v NUMINITIAL="$4" -v REWTYPE="$5"  -o ./log/ -e ./log/ -N aass-$jobname -t 1-$2 -b y 'matlab -nodisplay -nojvm < ./aass/run_aassGrid.m'
