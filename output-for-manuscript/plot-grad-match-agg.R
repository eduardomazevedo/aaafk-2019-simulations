...
gradient_data  <- fread('./analysis/gradient/output/gradient.csv')
probability_data  <- fread('./analysis/matching-probability/output/matching-probability.csv')
...
ggsave('./output-for-manuscript/figures/marginal-product-aggregated.pdf')
