function [poolSize,poolSizeVar] = poolMoments(directory,realdata)
...
poolSize{i} = [(mean(simAltPoolSize(1:330,:))) ;   (mean(simAltPoolSize(331:660,:))) ;         (mean(simAltPoolSize(661:end,:))) ;...
