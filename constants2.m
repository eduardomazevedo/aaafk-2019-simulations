...
scaleGrid = [linspace(10, 200, 20), ...
    linspace(240, 1000, 20), ...
    linspace(1100, 2000, 10)];
...
averageProdNKR = SS.f_mean(NKRsize)/SS.scaleGrid(NKRsize);
averageProdDoubleNKR = SS.f_mean(doubleNKR)/SS.scaleGrid(doubleNKR);
averageProdHalfNKR = SS.f_mean(halfNKR)/SS.scaleGrid(halfNKR);
...
dlmwrite('./output-for-manuscript/constants/c-total-DWL-of-APD.txt',DWLUNOS,'precision','%.1f')
...
averageLengthChain = nanmean(S.history.nTransplantsChains./S.history.chainTransplanted) + 1;
...
dlmwrite('./output-for-manuscript/constants/c-number-of-centers-no-participate-nkr.txt',centersinNoParticipateNKR,'precision','%.0f')
dlmwrite('./output-for-manuscript/constants/c-total-DWL-of-centers-no-participate-nkr.txt',DWLNoParticipateNKR,'precision','%.1f')
dlmwrite('./output-for-manuscript/constants/c-number-of-centers-no-participate-platform.txt',centersinNoParticipatePlatform,'precision','%.0f')
dlmwrite('./output-for-manuscript/constants/c-total-DWL-of-centers-no-participate-platform.txt',DWLNoParticipatePlatform,'precision','%.1f')
...
dlmwrite('./output-for-manuscript/constants/c-average-transplanted-length-chain.txt',averageLengthChain,'precision','%.2f')
